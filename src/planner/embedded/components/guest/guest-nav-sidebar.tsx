    ...
    <aside className="w-60 min-h-screen bg-white border-r border-slate-200 flex flex-col shrink-0">
      ...
      <div className="px-3 py-4 border-t border-slate-100 space-y-2">
        <Link
          ...
          className="flex w-full items-center justify-center rounded-lg bg-blue-600 px-3 py-2.5 text-sm font-medium text-white hover:bg-blue-700 transition-colors"
        >
          Sign in to save
        </Link>
        <p className="text-[10px] text-slate-500 text-center px-1">Guest mode: progress on this device only</p>
      </div>
    </aside>
  )
}
