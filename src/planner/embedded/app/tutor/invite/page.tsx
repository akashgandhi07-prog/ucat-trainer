...
export default function TutorInvitePage() {
  ...
  return (
    <div className="max-w-lg mx-auto px-6 py-10 space-y-6">
      <div>
        <Link href="/tutor" className="text-sm text-primary hover:text-foreground font-medium">
          ← Back to overview
        </Link>
          ...
          {inviteUrl && (
            <div className="space-y-2">
              ...
              <div className="flex flex-col sm:flex-row gap-2">
                <code className="flex-1 text-xs bg-slate-100 border border-border rounded-lg px-3 py-2 break-all">
                  {inviteUrl}
                </code>
