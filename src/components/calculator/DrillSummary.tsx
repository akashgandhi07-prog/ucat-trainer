...
export const DrillSummary = ({
    ...
    return (
        <div className="flex flex-col items-center justify-center p-8 bg-card rounded-xl shadow-lg border border-border animate-in zoom-in-95 duration-300 max-w-xl mx-auto w-full">
            <h2 className="text-2xl font-bold text-foreground mb-2">{drillName} Complete!</h2>
            ...
            <div className="grid grid-cols-2 gap-4 w-full mb-8">
                <div className="bg-secondary p-4 rounded-xl flex flex-col items-center">
                    ...
                    <span className="text-xs text-primary font-semibold uppercase tracking-wider">Score</span>
                </div>
                ...
                <div className="bg-secondary p-4 rounded-xl flex flex-col items-center">
                    <span className="text-2xl font-bold text-foreground pt-2">{kps}</span>
                    <span className="text-xs text-muted-foreground font-semibold uppercase tracking-wider mt-auto">KPS</span>
                </div>
            </div>
            ...
            <div className="w-full space-y-4 mb-8">
                {bestKey && (
                    <div className="flex items-center justify-between p-3 bg-secondary rounded-lg border border-border">
                        <span className="text-sm font-medium text-muted-foreground">Best Key</span>
                ...
                {!bestKey && !worstKey && (
                    <div className="flex items-center gap-2 p-3 bg-secondary text-foreground rounded-lg text-sm">
            ...
            <div className="flex gap-4 w-full">
                <button
                    onClick={onMenu}
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-secondary hover:bg-slate-200 text-foreground font-semibold rounded-lg transition-colors"
                >
                ...
                <button
                    onClick={onRetry}
                    className="flex-1 flex items-center justify-center gap-2 px-4 py-3 bg-primary text-primary-foreground hover:bg-primary/90 font-semibold rounded-lg transition-colors hover:shadow"
                >
