...
export default function Header() {
    ...
    <>
      ...
      {user ? (
        <div className="flex items-center gap-2 min-h-[44px]">
          <span className="text-sm text-muted-foreground inline-flex items-center" aria-label={displayName ? `Signed in as ${displayName}` : "Signed in"}>
          ...
          <button
            ...
            className="text-sm font-medium text-muted-foreground hover:text-foreground px-2 py-1 rounded hover:bg-secondary disabled:opacity-50"
            aria-label="Sign out"
          >
        ...
        <>
          <button
            ...
            className="px-4 py-2.5 min-h-[44px] text-sm font-medium text-foreground hover:text-primary hover:bg-secondary rounded-lg transition-colors shrink-0 inline-flex items-center justify-center"
            aria-label="Register"
          >
            Register
          </button>
          <button
            ...
            className="px-4 py-2.5 min-h-[44px] text-sm font-medium bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg transition-colors shrink-0 inline-flex items-center justify-center"
            aria-label="Login"
          >
            Login
          </button>
  ...
  return (
    <header className="border-b border-border bg-background/80 backdrop-blur-sm sticky top-0 z-10 pt-[env(safe-area-inset-top)]">
      {showSessionRecovery && (
      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6 py-2 sm:py-4 flex items-center justify-between gap-2 sm:gap-4">
        <div className="flex items-center gap-2 sm:gap-4 min-h-[44px]">
          <button
            ...
            className="sm:hidden -m-2 p-2 text-muted-foreground hover:text-foreground"
        ...
        {mobileMenuOpen && (
          <div
            className="absolute left-0 right-0 top-full border-b border-border bg-background shadow-lg sm:hidden z-20"
            aria-hidden="false"
          >
