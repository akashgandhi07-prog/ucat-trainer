      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            description: "30-min call with a UCAT expert",
            badge: "Free",
            badgeColor: "blue",
          },
        ],
    ...
    groups: [
      {
        items: [
          ...
          {
            label: "Medicine & Dentistry PS",
            href: `${BASE}/personal-statement-medicine-dentist`,
            description: "Dual-application statement support",
            badge: "From £149",
            badgeColor: "rose",
          },
        ],
